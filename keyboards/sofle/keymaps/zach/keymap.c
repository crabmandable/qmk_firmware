...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
            ...
            KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_MUTE, KC_RBRC, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
                           KC_LGUI, KC_LALT, TG(2), LALT_T(KC_ENT), OSL(1),
                           KC_SPC, KC_ESC, RGB_TOG, RGB_MOD, KC_CAPS
    ),
    ...
    [1] = LAYOUT(
            ...
            KC_TRNS, KC_TRNS, KC_TRNS, KC_GRV, KC_PIPE, KC_TILD, KC_TRNS, KC_TRNS, KC_END, KC_PGDN, KC_PGUP, KC_TRNS, KC_TRNS,
    ...
    [3] = LAYOUT(
            ...
            KC_NO, KC_NO, KC_BTN3, KC_BTN4, KC_BTN5, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
